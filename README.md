## Old Version
- https://github.com/Arpita30-sudo/E-commerce-project-springBoot/tree/main
...
6. Open http://localhost:8080/ in your browser!
   * If you ran the [`basedata.sql`](https://github.com/Arpita30-sudo/E-commerce-project-springBoot/blob/master2/JtProject/basedata.sql)script on the database, you can log in with the following credentials as admin; otherwise you'll have to manually create an admin user in the database:
     * Username: `admin`
     * Password: `123`
...
# Workflow
- ![image](https://github.com/Arpita30-sudo/E-commerce-project-springBoot/assets/81226571/69951cb7-65e2-4225-8681-2542859aaec6)
### Controller
